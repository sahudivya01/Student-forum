...
<div class="login-wrap">
	<div class="login-html">
		...
		<div class="login-form">
			<form method="get" action="homecode1.php">
			...
			<div class="sign-up-htm">
				<form action="homecode.php" method="post" enctype="multipart/form-data">
				<div class="group">
					<label for="username" class="label">Username</label>
				...
				<div class="group">
					<label for="pic" class="label">Upload Pic</label>
				...
				<div class="group">
					...
					<input id="designation" name="designation" type="text" class="input">
				</div>
				<div class="group">
					<label for="country" class="label">Country</label>
					<input id="country" name="country" type="text" class="input">
				</div>
				<div class="group">
					<label for="state" class="label">State</label>
					<input id="state" name="state" type="text" class="input">
				</div>
